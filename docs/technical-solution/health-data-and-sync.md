...
>
> 下一版拆成「健康数据同步」与「训练记录同步」两条管线（训练不传心率曲线等重叠样本，可重做 iOS 页、不改 Web）见 [2026-09-12-health-workout-split-sync-design.md](../superpowers/specs/2026-09-12-health-workout-split-sync-design.md)。服务端瘦上传 / 脏日期汇总仍见 [2026-09-10-health-sync-replan-design.md](../superpowers/specs/2026-09-10-health-sync-replan-design.md)。
