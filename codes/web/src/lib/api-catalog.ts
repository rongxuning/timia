...
export const API_CATALOG: ApiCatalogEntry[] = [
  ...
  {
    method: "GET",
    path: "/views/schedule/priority",
    name: "日程优先级象限视图",
    requestJson: { headers: authBearer, query: { scope: "me | project", workspace_id: "uuid?", project_id: "uuid?" }, jsonBody: null },
    responseJson: { quadrants: { "1": [], "2": [], "3": [], "4": [] } },
  },
  {
    method: "GET",
  ...
  {
    method: "GET",
    path: "/views/workspace/{workspace_id}/dashboard",
    name: "工作空间首页仪表盘",
    requestJson: { headers: authBearer, query: null, jsonBody: null },
    responseJson: { name: "string", stats: "object", active_projects: "ProjectCard[]" },
  },
  {
    method: "GET",
    path: "/views/workspace/{workspace_id}/discussions",
    name: "工作空间最近讨论",
    requestJson: {
      headers: authBearer,
      query: { limit: "number", offset: "number", incomplete_only: "bool", include_comments: "bool", include_replies: "bool" },
      jsonBody: null,
    },
    responseJson: { items: "DiscussionViewItem[]", has_more: true },
  },
  {
    method: "GET",
    path: "/views/workspace/{workspace_id}/activity",
    name: "工作空间活动记录",
    requestJson: { headers: authBearer, query: { limit: "number (1-200)?" }, jsonBody: null },
    responseJson: { total_count: "number", latest_at_label: "string | null", items: "ActivityTimelineItem[]" },
  },
  {
    method: "GET",
    path: "/views/workspace/{workspace_id}/members-page",
    name: "工作空间成员管理页",
    requestJson: { headers: authBearer, query: null, jsonBody: null },
    responseJson: { can_manage_workspace: "bool", members: "MembershipRow[]", assignable_users: "AssignableUser[]" },
  },
  {
    method: "GET",
    path: "/views/workspace/{workspace_id}/projects/{project_id}/members-page",
    name: "项目成员管理页",
    requestJson: { headers: authBearer, query: null, jsonBody: null },
    responseJson: { can_manage_project: "bool", project_members: "MembershipRow[]", workspace_member_pool: "AssignableUser[]" },
  },
  {
    method: "GET",
    path: "/views/users/directory",
    name: "全局用户目录",
    requestJson: { headers: authBearer, query: null, jsonBody: null },
    responseJson: { user_total: "number", users: "UserDirectoryRow[]" },
  },
  {
    method: "GET",
    path: "/views/workspace/{workspace_id}/projects/{project_id}/dashboard",
    name: "项目首页仪表盘",
    requestJson: { headers: authBearer, query: null, jsonBody: null },
    responseJson: { name: "string", members: "object", stats: "ScheduleDashboardOut" },
  },
  {
    method: "GET",
    path: "/views/workspace/{workspace_id}/projects/{project_id}/task-drawer-context",
    name: "任务抽屉上下文",
    requestJson: { headers: authBearer, query: null, jsonBody: null },
    responseJson: { workspace_name: "string", project_name: "string", member_options: "AssignableUser[]" },
  },
  {
    method: "GET",
    path: "/views/workspace/{workspace_id}/projects/{project_id}/items/{item_id}/detail",
    name: "任务详情（含评论）",
    requestJson: { headers: authBearer, query: null, jsonBody: null },
    responseJson: { title: "string", comments: "ItemDetailComment[]" },
  },
  {
    method: "GET",
    path: "/views/me/analytics",
    name: "我的数据分析",
    requestJson: { headers: authBearer, query: null, jsonBody: null },
    responseJson: { task_total: "number", health_percent: "number | null", workspace_count: "number" },
  },
  {
    method: "GET",
    path: "/views/users/{user_id}/membership-detail",
    name: "用户工作空间归属详情",
    requestJson: { headers: authBearer, query: null, jsonBody: null },
  ...
  },
  {
    ...
    requestJson: {
      headers: authBearer,
      query: null,
      jsonBody: { name: "string", description: "string | null", color: "string (#RRGGBB, default #FFFFFF)" },
    },
    responseJson: {
      id: "string (uuid)",
      name: "string",
  ...
  },
  {
    ...
    requestJson: {
      ...
      pathParams: workspacePath,
      query: null,
      jsonBody: { name: "string | null", description: "string | null", color: "string (#RRGGBB) | null" },
    },
    responseJson: {
      id: "string (uuid)",
      name: "string",
